...
public class GamePlayManager : MonoBehaviour
{
    ...
    public void PutCardToWastePile(Card c, Player p = null)
    {
        ...
        if (p != null)
        {
            ...
            else
            {
                ...
                {
                    NextPlayerIndex();
                    CurrentPlayer.ShowMessage("¡Salta Turno!");
                    Invoke("NextPlayerTurn", 1.5f);
                }
    ...
    private IEnumerator RemovePlayerFromRoom(float time)
    {
        ...
        Toast.instance.ShowMessage(player.playerName + " salió de la partida", 2.5f);
    ...
    {
        DisableUnoBtn();
        CurrentPlayer.ShowMessage("Cargos Uno");
    ...
    public void SetupGameOver()
    {
        ...
        if (players.Count == 2)
        {
            ...
            playerObject[2].transform.GetChild(2).GetComponent<Text>().text = "2ª plaza";
        ...
        else if (players.Count == 3)
        {
            ...
            playerObject[2].transform.GetChild(2).GetComponent<Text>().text = "3ª plaza";
        ...
        gameOverPopup.GetComponentInChildren<Text>().text = winner.isUserPlayer ? "Ganas el juego." : "Perdiste el juego... Inténtalo de nuevo.";
        fastForwardTime = 0;
    }
